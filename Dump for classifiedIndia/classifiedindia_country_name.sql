...
CREATE TABLE `country_name` (
  ...
  `country_short_name` varchar(200) DEFAULT NULL,
  `country_national_flag` varchar(200) DEFAULT NULL,
...
INSERT INTO `country_name` VALUES ('BAN','Bangadesh','bangladesh',NULL),('IND','India','india',NULL);
