...
CREATE TABLE `location_name` (
  ...
  CONSTRAINT `location_name_ibfk_1` FOREIGN KEY (`country_code`) REFERENCES `country_name` (`country_code`)
...
INSERT INTO `location_name` VALUES (11,'IND','Kolkata'),(22,'BAN','Dhaka');
