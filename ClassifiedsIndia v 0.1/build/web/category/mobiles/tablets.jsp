...
<script language="javascript" src="category/mobiles/tablet_ajax.js" ></script>
<style>
    .td1 {
        font-size: medium;
        width: 60%;
    ...
    <table style="width: 100%; padding: 0px 20px 0px 20px">
        ...
        <tr>
            <td class="td1">Brand Name</td>
                <td class="td"><html:select property="tabletbrandId" styleId="tabletbrandId" onfocus="fetchTabletBrandList()">
