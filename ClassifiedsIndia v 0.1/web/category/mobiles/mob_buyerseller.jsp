        ...
        <div style="width: 100%; margin-bottom: 10px; border: 1px solid #f6f6a5; background-color: #f6f6a5">
            ...
            <table id="tab" width="100%">
                <tr>
                    ...
                    <td class="td"><b><%= (String) session1.getAttribute("mobibrandname")%></b></td>
                </tr>
                <tr>
                    <td class="td1"><b>Model</b></td>
                    <td class="td"><b><%= (String) session1.getAttribute("mobimodelname")%></b></td>
                </tr>
                <tr>
                    <td class="td1"><b>Operating System</b></td>
                    <td class="td"><b><%= (String) session1.getAttribute("mobiosname")%></b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="td1"><b>Includes</b></td>
                    <td class="td"><b><%= (String) session1.getAttribute("mobiincludesname")%></b></td>
                </tr>
                <tr>
